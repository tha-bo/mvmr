...
public class HomeSurveyFragment extends Fragment {
    ...
    private void UpdateUsage(SharedPreferences prefs)
    {
        TrayModule tray = new TrayModule(_context);
        long weekTotal = tray.getLong("weekTotal", 0L);
        long dayTotal = tray.getLong("dayTotal", 0L);
