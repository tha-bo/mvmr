...
import reporting.mvmr.models.SurveyModel;
...
public class Survey extends AppCompatActivity  implements SurveyQuestionFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        raceSpinner.setOnItemSelectedListener( new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                surveyCache.edit().putInt("race", (int)(parent).getSelectedItemId()).commit();
            }
        ...
        sexSpinner.setOnItemSelectedListener( new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                surveyCache.edit().putInt("sex", (int)(parent).getSelectedItemId()).commit();
            }
        ...
        ageSpinner.setOnItemSelectedListener( new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                surveyCache.edit().putInt("age", (int)(parent).getSelectedItemId()).commit();
            }
        ...
        raceSpinner.setSelection(surveyCache.getInt("race", 0));
        sexSpinner.setSelection(surveyCache.getInt("sex", 0));
        ageSpinner.setSelection(surveyCache.getInt("age", 0));
    ...
    public void onSubmit(View view) {
        ...
        TrayModule tray = new TrayModule(Survey.this);
        SurveyModel model = new SurveyModel(tray.getString("user_id", null), new SimpleDateFormat("yyyy/MM/dd HH:mm:ss").format(new Date()), "");
        ...
        if(raceSpinner.getSelectedItemId() == 0)
        {
            Toast.makeText(Survey.this, "Please enter your race", Toast.LENGTH_SHORT).show();
            return;
        }

        if(sexSpinner.getSelectedItemId() == 0)
        {
            Toast.makeText(Survey.this, "Please enter your sex", Toast.LENGTH_SHORT).show();
            return;
        }

        if(ageSpinner.getSelectedItemId() == 0)
        {
            Toast.makeText(Survey.this, "Please enter your age", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        model.Race = raceSpinner.getSelectedItem().toString();
        model.Sex = sexSpinner.getSelectedItem().toString();
        model.Age = ageSpinner.getSelectedItem().toString();
